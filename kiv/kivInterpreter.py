...
class Interpreter:
	...
	def visit_ImportNode(self,node,context):
		...
		if node.file.value == "time":
			...
			return res.success(Int(0))
		elif node.file.value == "os":
			context.symbol_table.symbols |= ModuleOS.symbols
			return res.success(Int(0))
		elif node.file.value == "random":
			context.symbol_table.symbols |= ModuleRandom.symbols
			return res.success(Int(0))
		elif node.file.value == "keyboardMouse":
			context.symbol_table.symbols |= ModuleKeyboardMouse.symbols
			return res.success(Int(0))
